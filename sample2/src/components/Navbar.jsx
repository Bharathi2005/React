...
const Navbar = () => {
    ...
    return (
        <>
            <div className="w-full h-[4rem] flex justify-center items-center bg-orange-500 shadow-md shadow-orange-700 rounded-sm">
                <div className="w-[80%] h-full flex justify-center items-center flex-row">
                    <div className='w-1/2 flex h-full justify-start items-center font-bold text-xl text-white'>BHARATHI A K</div>
                    <div className='w-1/2 flex  h-full justify-end items-center'>
                        ...
                        <User2 className='h-9 w-10 text-white rounded-full border-2 border-white hover:bg-white  hover:border-orange-500 hover:text-orange-500' onClick={() => setvisible(true)} />
                    </div>
                </div>
                    ...
                    <>
                        <div className="h-screen w-screen absolute top-0 left-0 bg-black/20 flex justify-center items-center z-50">
                            <div className=" h-[40%] w-[30%] bg-red z-50 flex flex-col  bg-white  shadow-lg ">
                                <div className="w-full h-[15%] flex flex-row justify-start px-10 items-center border-2 text-white bg-orange-500 text-xl font-bold ">
                                    <div className="w-1/2">
                                        Login
                                    </div>
                                ...
                                <div className="w-full h-[85%] flex flex-row justify-center items-center">
                                    <form className="w-[80%] h-[80%] flex flex-col justify-center items-center gap-4" onSubmit={handleLogin}>
                                        <input type="email" ref={emailref} name="" id="email" placeholder="email" className="p-3 bg-[#f8f8f8] w-full font-bold outline-none active:outline-none focus:border-b-2 hover:border-orange-500" required />
                                        <input type="password" ref={passwordref} name="" id="password" placeholder="password" className="p-3 bg-[#f8f8f8] w-full font-bold outline-none active:outline-none focus:border-b-2 hover:border-orange-500" required />
